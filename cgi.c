...
static void
cgi_init_env(const char *method, const char *version, const char *query, const char *script, const char *server, const char *port, const char *address){
...
cgi_exec(int sock, const char *path, const char *method, const char *version, const char *query, const char *script, const char *port, const char *address){
	...
	if(pid == 0){
		...
		cgi_init_env(method, version, query, script, "localhost", port, address);
